...
feature 'Sign in', :devise do
  ...
  # Scenario: member cannot sign in if not registered
  ...
  # Scenario: member can sign in with valid credentials
  ...
  # Scenario: member cannot sign in with wrong email
  #   Given I exist as a member
  #   And I am not signed in
  ...
  # Scenario: member cannot sign in with wrong password
  #   Given I exist as a member
  #   And I am not signed in
